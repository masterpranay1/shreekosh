    ...
    <section className="flex flex-row gap-12 lg:gap-20 p-8 md:p-12 lg:p-24 xl:px-32 border-y">
      <div className="w-full md:w-1/2 flex flex-col gap-4">
        ...
        <p className="lg:text-xl">
          We&apos;re revolutionizing access to medicine in India, and we&apos;re looking
          for passionate individuals to join our mission. Explore exciting
          career opportunities across various departments and be part of a
          company dedicated to improving healthcare for all.
        </p>
        <Button
